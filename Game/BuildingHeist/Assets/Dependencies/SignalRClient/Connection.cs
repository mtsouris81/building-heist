...
namespace SignalR.Client._20
{
    public class Connection : IConnection
    {
        ...
        public IDictionary<string, object> QueryStringParams { get; private set; }
        ...
        public Connection(string url, IDictionary<string, object> queryString)
            : this(url, CreateQueryString(queryString))
        {
            QueryStringParams = queryString;
        }

        private Connection(string url, string queryString)
        {
            if (url.Contains("?"))
        ...
        public IDictionary<string, string> ParseQueryString(string qs)
        {
            Dictionary<string, string> result = new Dictionary<string, string>();
            string clean = qs.Replace("?", "");
            string[] kvs = clean.Split(new char[] { '&' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        {
            this.QueryString = CreateQueryString(this.QueryStringParams);
        }

        private static string CreateQueryString(IDictionary<string, object> queryString)
        {
