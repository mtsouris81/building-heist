...
public class UiSelectorSurface : MonoBehaviour, IPointerDownHandler, IPointerUpHandler {
    ...
    public MobileController.MobileControllerMode Mode = MobileController.MobileControllerMode.Desktop;
    ...
    public virtual void Update()
    {
        ...
        if (isPointerDown)
        {
            if (Mode == MobileController.MobileControllerMode.TouchDevice)
            {
